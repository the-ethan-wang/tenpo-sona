...
oops i wanted to learn shorthand a long time ago like lol thats not happening
...
- algorithmic game theory (in `procrastinate/`)
- conways game of life (in `done/`)
- lambda calculus (in `done/`)
...
boring (aka life simiulation adjacent)  
...
- https://www.youtube.com/watch?v=ldxFjLJ3rVY&t=175s
